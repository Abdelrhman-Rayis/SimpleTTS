...
- **Arabic Neural TTS:** Optional Azure Speech voices for more natural Arabic pronunciation when you set a cloud key and region.
...
5. For Azure Arabic voices, set `AZURE_SPEECH_KEY` and `AZURE_SPEECH_REGION` in your shell before starting the app.
